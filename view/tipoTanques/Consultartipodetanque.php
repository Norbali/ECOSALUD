...
<head>
    ...
    <title>Tipos de de Tanques - KaiAdmin</title>
...
<body>
    <div class="container-fluid px-4 py-4">
        ...
        <div class="page-header">
            <h1 class="h3 mb-2">
                <i class="fas fa-tasks text-primary"></i> Tipo de tanques
            </h1>
        </div>

        <!-- Card con Tabla -->
        <form action="<?php echo getUrl("TipoTanques", "ConsultartipodeTanques", "getConsulta") ?>" method="POST">
            <div class="card">
